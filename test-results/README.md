...
- `npm run multiplayer` - two-browser production Host/Join flow, protocol 2 realm/start gating, bidirectional movement, remote avatars, authoritative combat/stronghold/chest convergence, strict chest range, same-identity reconnect, party HUD, and Solo no-connect audit
