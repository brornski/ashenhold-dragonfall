...
- `npm run smoke` - deterministic gameplay regression, including layout 8 world scale, the owner-supplied fixed tree LOD/culling layer, capture flags, strongholds, relic power, taming, collision, sprint, and victory
...
- `npm run audit` - six fixed-continent biome zones, sky transitions, supplied tree LOD forests and regional exclusions, infrastructure, progression, combat, save, scale, living AI, motion, co-op packaging, and 844x390 audit
