...
- World: 1,800 metres, one unit per metre, layout version 8, six authored biome/sky/ecology families, 48 infrastructure sites, six walkable ascent structures, six forts, a keep, and connected settlement POIs on one fixed continent. Primitive procedural forest and scattered tree-prop layers are disabled. Preserve the owner-supplied three-LOD fixed forest in Drowned Coast, Verdant Ruins, Frostbound Wilds, and Sky-Sunder Peaks; its Ember Dunes and Moonfall counts must remain zero. Preserve authored/imported/Forge tree placements independently.
