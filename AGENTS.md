...
- Sky: Ember Dunes and Moonfall use owner-supplied local 2K equirectangular panoramas with procedural fallbacks; the other four region skies remain procedurally generated.
