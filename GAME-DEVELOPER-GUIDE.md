...
Primitive ancient-forest geometry and the scattered procedural snow pines, broadleaf trees, palms, and dark pines are disabled across all six biomes. `assets/models/tree-lods/` supplies the active forest: 2,200 fixed placements on desktop and 990 on coarse devices, split among Drowned Coast (430/190), Verdant Ruins (800/360), Frostbound Wilds (570/260), and Sky-Sunder Peaks (400/180). Ember Dunes and Moonfall counts are exactly zero. Placement is stable for the authored continent, rejects water, steep terrain, roads, routes, POIs, forts, infrastructure, and spawn/title clearings, and enforces biome-specific spacing. Eighty-two spatial chunks switch between the supplied 21.5k-, 9k-, and 4.3k-triangle meshes; only the nearest giant trunks receive colliders. Other tree assets remain in the model catalog for deliberate POI and Forge placement. Fixed infrastructure still adds 24-32 biome-specific micro-landmarks such as collapsed walls, abandoned farms, hunter platforms, drowned piers, carts, and waystones outside protected routes and strongholds.
